...
class OmniASRConfig(PreTrainedConfig):
    r"""
    This is the configuration class to store the configuration of an [`OmniASRModel`]. It is used to instantiate an
    OmniASR encoder model according to the specified arguments, defining the model architecture. Instantiating a
    configuration with the defaults will yield a configuration similar to the audio encoder of the OmniASR-CTC-300M
    model, e.g. [bezzam/omniasr-ctc-300m-v2](https://huggingface.co/bezzam/omniasr-ctc-300m-v2).
...
class OmniASRCTCConfig(PreTrainedConfig):
    ...
    OmniASR-CTC model according to the specified arguments, defining the model architecture. Instantiating a
    configuration with the defaults will yield a configuration similar to the OmniASR-CTC-300M model
    [bezzam/omniasr-ctc-300m-v2](https://huggingface.co/bezzam/omniasr-ctc-300m-v2).
...
class OmniASRLLMConfig(PreTrainedConfig):
    ...
    architecture. Instantiating a configuration with the defaults will yield a configuration similar to the
    OmniASR-LLM-300M model [bezzam/omniasr-llm-300m-v2](https://huggingface.co/bezzam/omniasr-llm-300m-v2).
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Streaming ("unlimited"-length) inference: long audio is split into `segment_seconds` windows and decoded
        # segment-by-segment with cross-segment context. Consumed by `OmniASRForConditionalGeneration.generate`.
        self.is_streaming = is_streaming
        self.segment_seconds = segment_seconds
        self.num_context_segments = num_context_segments
